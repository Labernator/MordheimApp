package com.example.mordheimapp
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var requestGithubBtn: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestGithubBtn = findViewById(R.id.idBtnGeneratePdf)
        requestGithubBtn.setOnClickListener {
            loginAndRequestStuff()
        }
    }
    private fun loginAndRequestStuff() {
